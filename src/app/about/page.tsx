    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white text-gray-800 px-6 py-12">
      ...
      <section className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
          🍀 <strong>Luckycoin (LUK)</strong> – The digital coin of luck, connecting rewards and happiness.
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto text-center mb-16 leading-relaxed text-lg">
        <p>
          ...
          to everyday shopping. Customers can earn LUK when purchasing, then use it
      ...
      <section className="max-w-5xl mx-auto mb-20">
        <h2 className="text-3xl font-semibold text-green-700 mb-6 text-center">
          💎 Luckycoin Utility (LUK)
        </h2>
        <ul className="list-disc list-inside text-gray-700 text-lg space-y-3 max-w-3xl mx-auto">
          <li>Earn LUK as loyalty points when making purchases.</li>
          <li>Use LUK to redeem gifts, vouchers, or get instant discounts.</li>
          <li>Exchange LUK between stores or businesses within the Luckycoin network.</li>
      ...
      <section className="max-w-5xl mx-auto mb-20 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-gray-700">
          <div className="p-6 bg-white rounded-2xl shadow-md">
            ...
            <p>Customers can use LUK for discounts, gifts, or promotions anytime.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow-md">
      ...
      <section className="max-w-5xl mx-auto mb-20 text-center">
        ...
        <div className="bg-white p-6 rounded-2xl shadow inline-block text-left max-w-md mx-auto">
          <ul className="list-disc list-inside text-gray-700 space-y-3">
            <li><strong>Q4 2025:</strong> Official launch of Luckycoin (LUK).</li>
            <li><strong>Q1 2026:</strong> Integrate LUK reward app for stores.</li>
